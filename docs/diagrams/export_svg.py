...
The interactive HTML (osp-workflow.html) styles its inline SVG through CSS
...
substitutes each theme's concrete variable values before writing:
    ...
    assets/osp-workflow-light.svg
    assets/osp-workflow-dark.svg
...
HTML = ROOT / "docs" / "diagrams" / "osp-workflow.html"
ASSETS = ROOT / "assets"
THEMES = ("light", "dark")
